            ...
            <div className="flex flex-row justify-center flex-1 w-full">
              <div className="flex lg:flex-row flex-col items-start lg:items-end gap-8 lg:gap-[38px]">
                ...
                <div className="flex flex-col items-center gap-10 w-full pt-[72px] lg:pt-0">
                  ...
                  {/* Form Box */}
                  <div className="bg-white/30 dark:bg-[#01101a]/80 shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] rounded-xl md:w-[460px] w-full lg:px-8 lg:py-10 p-6 flex flex-col items-center gap-6 backdrop-blur-xl border border-white/20 dark:border-neutral-700/20">
