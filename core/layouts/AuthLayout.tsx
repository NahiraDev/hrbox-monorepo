  ...
  return (
    ...
    >
      <div className="min-h-screen lg:px-10 px-4 flex items-center justify-center">
        <div
          className="w-full max-w-[1400px] flex lg:flex-row flex-col justify-between lg:gap-[156px] items-center lg:items-stretch py-20 lg:py-0">
            ...
            <div className="flex flex-row justify-center flex-1 w-full">
              <div className="flex lg:flex-row flex-col items-start lg:items-end gap-8 lg:gap-[38px]">
                ...
                <div className="flex flex-col items-center gap-[58px] w-full pt-[72px] lg:pt-0">
                  ...
                  <div
                    className="bg-white/30 dark:bg-[#01101a]/80 shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] rounded-xl w-[460px] px-[70px] py-10 flex flex-col items-center gap-6 backdrop-blur-xl border border-white/20 dark:border-neutral-700/20">
                    <div className="flex items-center justify-center w-full">
                      ...
                      <span
                        className="text-secondary-1000 lg:text-xl text-base lg:font-bold font-semibold dark:text-white">
