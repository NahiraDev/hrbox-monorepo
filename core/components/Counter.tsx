    ...
    <div className="flex items-center justify-between border-2 border-sky-500 rounded-[6px] ">
      <AppButton
        props={{
          ...
          variant: 'light',
          isIconOnly: true,
          content: <Minus className="text-black cursor-pointer" size={24} onClick={() => setCount(count - 1)} />,
        }}
      />
      ...
      <AppButton
        props={{
          ...
          variant: 'light',
          isIconOnly: true,
          content: <Add className="text-black cursor-pointer" size={24} onClick={() => setCount(count + 1)} />,
        }}
      />
    </div>
  );
