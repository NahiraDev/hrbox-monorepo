...
export const AppTextArea = ({ props }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("span", { className: `text-secondary-1000 lg:text-sm text-xs lg:font-medium font-semibold leading-5 dark:text-white ${lang === "en" && ""}`, children: [label, " ", required && "*"] }), _jsx(Textarea, { classNames: {
                    inputWrapper: inputWrapperClassNames,
                    input: inputClassNames,
                }, label: label, placeholder: placeholder, value: value, onBlur: handleBlur, onChange: formik.handleChange, onFocus: handleFocus })] }));
};
