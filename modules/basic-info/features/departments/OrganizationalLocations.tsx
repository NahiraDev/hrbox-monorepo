        ...
        {OrganizationalLocation.map((detail, index) => (
          ...
          >
            <div className="w-58 z-1000 flex absolute top-8  justify-end gap-2 ">
              {activeButton === index && (
                <Button key={index} className="w-27 mt-7 mr-[-30px] bg-white rounded-lg">
            ...
            <Avatar className="w-55 h-30" radius="sm" src="https://i.pravatar.cc/150?u=a04258a2462d826712d" />
            <div className="w-55">
