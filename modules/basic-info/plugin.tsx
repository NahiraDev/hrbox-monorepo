...
const OrganizationDepartments = lazyRouteComponent(
  () => import("./pages/departments/OrganizationDepartments"),
);
const TechnicalDepartments = lazyRouteComponent(
  () => import("./pages/departments/TechnicalDepartments"),
);
const OrganizationalLocations = lazyRouteComponent(
  () => import("./pages/departments/OrganizationalLocations"),
);
const TestReport = lazyRouteComponent(
  () => import("./pages/employees/More/TestReport"),
);
const HealthRecords = lazyRouteComponent(
  () => import("./pages/employees/More/HealthRecord"),
);
const Documents = lazyRouteComponent(
  () => import("./pages/employees/Documents"),
);
const Achievements = lazyRouteComponent(
  () => import("./pages/employees/Achievements"),
);
const RequestList = lazyRouteComponent(
  () => import("./pages/employees/More/RequestList"),
);
const Guidelines = lazyRouteComponent(
  () => import("./pages/employees/More/Guidelines"),
);
const Onboarding = lazyRouteComponent(
  () => import("./pages/employees/More/Onboarding"),
);
...
const Educations = lazyRouteComponent(
  () => import("./pages/employees/Education"),
);
const PersonalInformation = lazyRouteComponent(
  () => import("./pages/employees/PersonalInformation"),
);
const ContractList = lazyRouteComponent(
  () => import("./pages/employees/More/ContractList"),
);
const Dependents = lazyRouteComponent(
  () => import("./pages/employees/Dependents"),
);
const EmployeeSatisfactionCalendar = lazyRouteComponent(
  () => import("./pages/employees/EmployeeSatisfactionCalendar"),
);
...
const TechnicalDepartmentsSubHeader = lazyRouteComponent(
  () => import("./subheaders/TechnicalDepartmentsSubHeader"),
);
