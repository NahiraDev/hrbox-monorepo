...
const users = [
  ...
  },
  {
    ...
    name: "Zahra Pakniyati",
    role: "UiUx Designer",
    section: "Indirect Relationship With",
  },
  {
    id: "5",
    name: "Zahra Pakniyati",
  ...
  return (
    <div className={cardContainerClass}>
      ...
      <div className="w-full mt-3 ">
        <h3 className="text-lg !font-semibold mb-2 text-secondary-1000">
          Report To
        </h3>
        <Listbox
            ...
            <ListboxItem key={item.id} textValue={item.name}>
              <div className="flex items-center justify-start gap-4 w-full ">
                <Avatar
                  ...
                  radius="sm"
                  size="lg"
                  src="https://i.pravatar.cc/150?u=b04258114e29026302d"
                />
