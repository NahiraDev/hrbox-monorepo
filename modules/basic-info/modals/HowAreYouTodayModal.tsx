...
const HowAreYouTodayModal: React.FC<HowAreYouTodayModalProps> = ({
  onMoodSelect,
}) => {
  ...
  const IconWrapper: React.FC<{
    iconComponent: React.FC<SvgIconProps> | React.ComponentType<SvgIconProps>;
  }> = ({ iconComponent: Icon }) => <Icon width={80} height={80} />;
  ...
  return (
    <div className="px-12 py-3 bg-blue-50 rounded-3xl flex flex-col items-center justify-center gap-1 w-full max-w-lg mx-auto">
      <div>
        <span className="!text-[28px] text-secondary-400 !font-semibold">
          How are you today?
        </span>
      </div>
