...
import {JobOpportunitiesIcon} from "@hrbox/uikit/icons";
        ...
        <div className="flex justify-between">
            <div className="flex gap-2">
                <AppButton
                    ...
                    size="md"
                    radius="md"
                    onPress={() => push({to: Paths.HRLink.JobOffers})}
                    content={
                        <>
                            <JobOpportunitiesIcon
                                color={props.name === "Job Offers" ? "#fff" : "#1E3363"}
                            />
                            <span
                                className={`text-xl ${props.name === "Job Offers" ? "text-white" : "text-secondary-400"}`}
                            >
                  Job Offers
                </span>
                        </>
                ...
                <AppButton
                    ...
                    size="md"
                    radius="md"
                    onPress={() => push({to: Paths.HRLink.JobOpportunities})}
                    content={
                        <>
                            <JobOpportunitiesIcon
                                color={
                                    props.name === "Job Opportunities" ? "#fff" : "#1E3363"
                                }
                            />
                            <span
                                className={`text-xl ${props.name === "Job Opportunities" ? "text-white" : "text-secondary-400"}`}
                            >
                  Job Opportunities
                </span>
                        </>
