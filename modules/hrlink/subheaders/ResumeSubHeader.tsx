import {AppButton, AppPageTitle, AppSearchInput} from '@hrbox-monorepo/UIKit/components';
import {Add, ArrowLeft2, ArrowRight2, Personalcard, ReceiveSquare} from 'iconsax-reactjs';

const ResumeSubHeader = (props: any) => {

    return (
        <div className="flex justify-between">
            <AppPageTitle title="resume subheaders" icon={<Personalcard size={24} color="white"/>}/>
            <div className="flex gap-2">
                ...
                <AppButton
                    ...
                    size='md'
                    radius='sm'
                    startContent={<ReceiveSquare className="text-secondary-1000" size="16"/>}
                    content={
