...
export const HRLinkApiEndpoints = {
  resume:{
    ...
    skill: {
      ...
      getProfessionalSkills: `${BaseUrl}/UserSkill/UserSkillProfessionalAndSearch`,
      getAllSkills: `${BaseUrl}/UserSkill/UserSkillGeneralAndSearch`,
      getSoftSkill: `${BaseUrl}/UserSkill/GetSkillsByType?type=1`,
      getHardSkill: `${BaseUrl}/UserSkill/GetSkillsByType?type=2`,
      getUserSoftSkills: `${BaseUrl}/UserSkill/GetUserSkills?type=1`,
      getUserHardSkills: `${BaseUrl}/UserSkill/GetUserSkills?type=2`,
    },
  },
