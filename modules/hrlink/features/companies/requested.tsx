                      ...
                      >
                        ...
                        <div>
                          ...
                          <div className="flex justify-end">
                            <Button
                              className="bg-white dark:bg-info-1000 !rounded-2 shadow-shadow-light-tight/1 dark:shadow-shadow-dark-tight/1 px-1 py-0.5 h-5 hover:bg-secondary-400"
                              onPress={() => handleOpenCompany(company.name)}
                            >
                              <span className="text-secondary-1000 dark:text-white text-xs font-normal hover:text-white">
                                See More
                              </span>
                              <ArrowRight
