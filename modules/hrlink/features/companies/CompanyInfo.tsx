                ...
                <div className="flex gap-6">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex gap-8">
                      <span className="text-secondary-400 font-semibold text-base">Degital Solution</span>
                  ...
                  <div className="flex flex-col gap-3">
                    <div className="p-4 rounded-[8px] border border-[rgba(220,240,249,0.40)] bg-gradient-to-r from-[#FBF1EF] via-[#FCF8F8] via-50% via-[#F9F0F0] to-[#FCF4F3] backdrop-blur-[4px] flex justify-between dark:border-[rgba(4,66,92,0.40)] dark:bg-[linear-gradient(90deg,_#080E1C_0%,_#111D38_50%,_#080E1C_100%)]">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-secondary-900 text-base font-light leading-normal">Establishment</span>
                      </div>
                      <span className="text-secondary-900 text-base font-semibold leading-normal">1400</span>
                    </div>
                    <div className="p-4 rounded-[8px] border border-[rgba(220,240,249,0.40)] bg-gradient-to-r from-[#FBF1EF] via-[#FCF8F8] via-50% via-[#F9F0F0] to-[#FCF4F3] backdrop-blur-[4px] flex justify-between dark:border-[rgba(4,66,92,0.40)] dark:bg-[linear-gradient(90deg,_#080E1C_0%,_#111D38_50%,_#080E1C_100%)]">
                      <div className="flex items-center gap-1.5">
                        <Profile className="text-[#292D32]" size="16" />
                        <span className="text-secondary-900 text-base font-light leading-normal">No. Employees</span>
                      </div>
                      <span className="text-secondary-900 text-base font-semibold leading-normal">120</span>
                    </div>
                    <div className="p-4 rounded-[8px] border border-[rgba(220,240,249,0.40)] bg-gradient-to-r from-[#FBF1EF] via-[#FCF8F8] via-50% via-[#F9F0F0] to-[#FCF4F3] backdrop-blur-[4px] flex justify-between dark:border-[rgba(4,66,92,0.40)] dark:bg-[linear-gradient(90deg,_#080E1C_0%,_#111D38_50%,_#080E1C_100%)]">
                      <div className="flex items-center gap-1.5">
                        <LampCharge className="text-[#292D32]" size="16" />
                        <span className="text-secondary-900 text-base font-light leading-normal">Advantages</span>
                      </div>
                      <div className="flex gap-3">
                        <div className="flex items-center gap-1">
                          <TagUser size="16" />
                          <span className="text-secondary-900 text-base font-semibold leading-normal">Insurance</span>
                        </div>
                        <div className="flex items-center gap-1">
                          <CardAdd size="16" />
                          <span className="text-secondary-900 text-base font-semibold leading-normal">Loan</span>
                        </div>
                        <div className="flex items-center gap-1">
                          <MoneyChange size="16" />
