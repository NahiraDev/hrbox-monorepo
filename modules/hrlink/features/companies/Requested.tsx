...
import { AppButton, AppPagination, AppSearchInput } from '../../../../core';
                ...
                >
                  <div className="flex justify-between border-b-1 border-neutral-100 pb-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-base font-semibold text-secondary-1000 leading-normal">{company.name}</span>
                    </div>
                    <div className="flex gap-1">
                      <AppButton
                        props={{
                          ...
                          content: (
                            <>
                              <span className="text-secondary-1000">Applied</span>
                  ...
                  <div>
                    <div className="flex flex-col gap-4">
                      <span className="font-bold text-sm text-secondary-800 text-start">
                        {company.title}
                      </span>
                    ...
                    <div className="flex justify-end">
                      <AppButton
                        props={{
                          ...
                          content: (
                            <>
                              <span className="text-secondary-1000 text-xs font-normal hover:text-white">See More</span>
                              <ArrowRight className="hover:text-white" size="12" />
                            </>
                          ),
                        }}
                      />
