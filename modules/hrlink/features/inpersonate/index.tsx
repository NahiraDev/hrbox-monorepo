import { InpersonateLayout } from "@/pages/Inpersonate/Layout.tsx";
import { UserIcon } from "@/icons/user.tsx";
import InpersonateAvatar from "@/assets/img/inpersonate-avatar.png";

export default function Inpersonate() {
  return (
    <InpersonateLayout
      props={{
        children: (
          <div className="flex flex-col gap-12">
            <p className="text-secondary-1000 text-2xl font-normal text-justify">
              Please select your desired user panel from the list below to
              access relevant information and dedicated functionalities.
            </p>
            <div className="flex gap-3">
              <div className="bg-white p-6 rounded-5 flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <span className="text-tertiar-700 text-sm font-semibold">
                    Dev Chapter Leader
                  </span>
              ...
              <div className="bg-white p-6 rounded-5 flex flex-col gap-3">
                <div className="w-[140px] h-[140px] rounded-[18px] flex justify-center items-center">
                  <img
                    alt="inpersonate-avatar"
                    className="rounded-3xl"
                    src={InpersonateAvatar}
                  />
                </div>
                <div className="flex flex-col gap-3">
                  <span className="text-secondary-1000 text-sm font-semibold">
