...
import { JobOffersIcon, JobOppertunitiesIcon } from '@module/hrlink/icons';
        ...
        <div className="flex justify-between">
              ...
              props={{
                ...
                content: (
                  <>
                    ...
                    <span className="dark:text-white text-secondary-400 text-xl font-normal">Job Recommendations</span>
                  </>
                ),
              }}
            />
              ...
              props={{
                ...
                content: (
                  <>
                    ...
                    <span className="text-white text-xl font-normal">Job Opportunities</span>
                  </>
                ),
              }}
            />
          ...
          <div className="flex gap-3">
            <div className="flex items-center gap-2">
              <AppSearchInput placeholder="Education" onSearch={(query) => fetchJobOpportunities({ query })} />
            </div>
            <AppButton
              props={{
                isIconOnly: true,
        ...
        <div className="flex flex-col h-full justify-between">
          <div className="grid grid-cols-3 gap-3">
            {jobOpportunitiesData.map((oppertunitie: any, index) => (
              <button key={index} onClick={() => handleOpenJobDetails(oppertunitie.company)}>
                <div
                  key={index}
                ...
                >
                  <div className="flex justify-between pb-1 border-b-1 border-neutral-100 dark:border-neutral-700">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-secondary-1000 dark:text-white font-semibold">{oppertunitie.Name}</span>
                    </div>
                    <div className="flex gap-1">
                      <Button
                        ...
                        variant="light"
                      >
                        <span className="text-secondary-1000 dark:text-white text-[10px] font-normal">Easy Apply</span>
                        <DocumentForward className="text-secondary-1000 dark:text-white" size="12" />
                      </Button>
                    </div>
                  </div>
                  <div className="flex justify-between pt-2">
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="flex items-center gap-2">
                        <Location className="text-secondary-1000 dark:text-white" size="16" />
                      ...
                      <div className="flex items-center gap-2">
                        <Clock className="text-secondary-1000 dark:text-white" size="16" />
                        <span className="text-secondary-1000 dark:text-white text-sm font-normal">
                          {oppertunitie.type}
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                        <DollarCircle className="text-secondary-1000 dark:text-white" size="16" />
                        <span className="text-secondary-1000 dark:text-white text-sm font-normal">
                          {oppertunitie.salary}
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-info-700 dark:text-white text-sm font-normal">{oppertunitie.status}</span>
                      </div>
                    </div>
                    <div className="flex flex-col gap-3">
                      <div className="flex justify-end">
                        <img alt="" className="w-[84px] h-[84px] rounded-5" src={jobCompanyLogo} />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex flex-col gap-1 !p-0">
            <div className="flex justify-between items-center">
              <div className="bg-secondary-400 shadow-shadow-light-tight/1 rounded-4 flex gap-2 px-3 py-1.5 w-fit">
                ...
                <span className="text-white font-normal text-xl">Filter</span>
              </div>
            </div>
          </div>
        }
            ...
            <div className="flex flex-col gap-2 w-full h-full max-w-md items-start justify-center">
              <Slider
                ...
                classNames={{
                  ...
                  thumb: '!bg-secondary-400 after:bg-primary-0 !w-4 !h-4 after:!w-3 after:!h-3',
                  track: '!h-1',
                }}
                formatOptions={{
                  style: 'currency',
