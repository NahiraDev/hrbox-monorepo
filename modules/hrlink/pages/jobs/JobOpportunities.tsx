              ...
              <div className="rounded-5 shadow-shadow-light-tight/1 px-3 py-4">
                <div className="flex justify-between pb-1 border-b-1 border-neutral-100 dark:border-neutral-700">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-secondary-1000 font-semibold">{oppertunitie.Name}</span>
                  </div>
                  <div className="flex gap-1">
                    <Button
                      ...
                      variant="light"
                    >
                      <span className="text-secondary-1000 text-[10px] font-normal">Easy Apply</span>
                ...
                <div className="flex justify-between pt-2">
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-secondary-1000 text-sm font-normal">{oppertunitie.type}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <DollarCircle className="text-secondary-1000" size="16" />
                      <span className="text-secondary-1000 text-sm font-normal">{oppertunitie.salary}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Status className="text-info" size="20" variant="Bold" />
                      <span className="text-info-700 text-sm font-normal">{oppertunitie.status}</span>
                    </div>
                  </div>
