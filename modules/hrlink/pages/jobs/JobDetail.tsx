...
const JobDetail = () => {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 h-full">
      <div className="rounded-xl shadow-theme-sm bg-white px-4 py-3 flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="p-4 rounded-[8px] border border-[rgba(220,240,249,0.40)] bg-gradient-to-r from-[#FBF1EF] via-[#FCF8F8] via-50% via-[#F9F0F0] to-[#FCF4F3] backdrop-blur-[4px] flex justify-between dark:border-[rgba(4,66,92,0.40)] dark:bg-[linear-gradient(90deg,_#080E1C_0%,_#111D38_50%,_#080E1C_100%)]">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-secondary-900 font-light">Website</span>
            </div>
            <span className="text-secondary-900 font-semibold">hrbox.me</span>
          </div>
          <div className="p-4 rounded-[8px] border border-[rgba(220,240,249,0.40)] bg-gradient-to-r from-[#FBF1EF] via-[#FCF8F8] via-50% via-[#F9F0F0] to-[#FCF4F3] backdrop-blur-[4px] flex justify-between dark:border-[rgba(4,66,92,0.40)] dark:bg-[linear-gradient(90deg,_#080E1C_0%,_#111D38_50%,_#080E1C_100%)]">
            <div className="flex items-center gap-1.5">
              <ReceiptItem className="text-[#292D32]" size="16" />
              <span className="text-secondary-900 font-light">Industrial</span>
            </div>
            <span className="text-secondary-900 font-semibold">IT</span>
          </div>
          <div className="p-4 rounded-[8px] border border-[rgba(220,240,249,0.40)] bg-gradient-to-r from-[#FBF1EF] via-[#FCF8F8] via-50% via-[#F9F0F0] to-[#FCF4F3] backdrop-blur-[4px] flex justify-between dark:border-[rgba(4,66,92,0.40)] dark:bg-[linear-gradient(90deg,_#080E1C_0%,_#111D38_50%,_#080E1C_100%)]">
            <div className="flex items-center gap-1.5">
              <LampCharge className="text-[#292D32]" size="16" />
              <span className="text-secondary-900 font-light">Advantages</span>
            </div>
            <span className="text-secondary-900 font-semibold">Bachelor</span>
          </div>
          <div className="p-4 rounded-[8px] border border-[rgba(220,240,249,0.40)] bg-gradient-to-r from-[#FBF1EF] via-[#FCF8F8] via-50% via-[#F9F0F0] to-[#FCF4F3] backdrop-blur-[4px] flex justify-between dark:border-[rgba(4,66,92,0.40)] dark:bg-[linear-gradient(90deg,_#080E1C_0%,_#111D38_50%,_#080E1C_100%)]">
            <div className="flex items-center gap-1.5">
              <Location className="text-[#292D32]" size="16" />
              <span className="text-secondary-900 font-light">Address</span>
            </div>
            <span className="text-secondary-900 font-semibold">Female</span>
          </div>
          <div className="p-4 rounded-[8px] border border-[rgba(220,240,249,0.40)] bg-gradient-to-r from-[#FBF1EF] via-[#FCF8F8] via-50% via-[#F9F0F0] to-[#FCF4F3] backdrop-blur-[4px] flex justify-between dark:border-[rgba(4,66,92,0.40)] dark:bg-[linear-gradient(90deg,_#080E1C_0%,_#111D38_50%,_#080E1C_100%)]">
            <div className="flex items-center gap-1.5">
