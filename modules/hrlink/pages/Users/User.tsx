...
import {
  ...
  ModalType,
  ModalSize,
} from "@hrbox/core/providers/ModalContext";
import {
  FormProvider,
  FormField,
  useFormContext,
  FormMode,
} from "@hrbox/core/components/forms";
import { AppButton } from "@hrbox/hrbox/uikit/components";
import {
  AppInput,
  AppAutoComplete,
  AppDatePicker,
      ...
      <div className="flex gap-3 justify-end pt-6 border-t border-neutral-200 dark:border-neutral-700">
        ...
        <AppButton
          props={{
            ...
            onPress:
              formMode === FormMode.VIEW
                ? () => closeModal(ModalType.VIEW, "user-form")
                : handleFormSubmit,
          }}
        />
      </div>
