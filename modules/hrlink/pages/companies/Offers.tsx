...
import {JobOffersIcon} from "@hrbox/uikit/icons/JobOffersIcon";
        ...
        <div className="flex gap-2">
          ...
          <AppButton
            props={{
              ...
              size: 'md',
              radius: 'md',
              onPress: () => navigate.push({to:Paths.HRLink.JobOffers}),
              content: (
                <>
          ...
          <AppButton
            props={{
              ...
              size: 'md',
              radius: 'md',
              onPress: () => navigate.push({to:Paths.HRLink.CompanyEvents}),
              content: (
                <>
