        ...
        {data &&
          data.map((company: any) => {
            ...
            return (
              <button
                key={company.id}
                className=" dark:bg-info-1000 rounded-5 shadow-theme-sm px-5 py-4 flex flex-col gap-2 cursor-pointer"
                  ...
                  <div className="flex justify-end">
                    <AppButton
                      props={{
                        ...
                        content: (
                          <>
                                <span className="text-secondary-1000 text-xs font-normal hover:text-white">
                                  See More
                                </span>
