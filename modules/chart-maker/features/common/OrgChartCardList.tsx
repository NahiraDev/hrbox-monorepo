...
export const OrgChartCardListNode = () => {
  ...
  return (
    <div onClick={()=> navigate.push('/chart-maker/OrgChart')} className="flex border-l-[2px] border-primary-panel items-start flex-col gap-2 bg-white rounded-xl shdow-theme-sm dark:shadow-dark-tight-1 py-2 px-3">
      ...
      <div className=" flex flex-col gap-1.5 items-start ">
        ...
        <div className="flex items-center gap-4">
          <User className="items-center text-primary-panel dark:text-gold" size="18" />
          <p className="text-sm font-normal text-primary-panel dark:text-gold  leading-normal gap-2">
            22 people
          </p>
        </div>
      </div>
