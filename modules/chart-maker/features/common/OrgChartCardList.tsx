...
export const OrgChartCardListNode = () => {
  ...
  return (
    <div onClick={()=> navigate.push('/chart-maker/OrgChart')} className="flex border-l-[2px] border-primary items-start flex-col gap-2 bg-white rounded-xl shdow-theme-sm dark:shadow-dark-tight-1 py-2 px-3">
