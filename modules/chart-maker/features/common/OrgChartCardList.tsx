...
export const OrgChartCardListNode = () => {
  ...
  return (
    <div onClick={()=> navigate('/chart-maker/OrgChart')} className="flex border-l-[2px] border-primary-400 items-start flex-col gap-2 bg-white rounded-xl shadow-light-tight-1 dark:shadow-dark-tight-1 py-2 px-3">
