...
export const OrganizationCard = ({ props }: { props: any }) => {
  ...
  return (
    <div
      key={id}
      className="flex border-l-[2px] border-primary-400 items-start flex-col gap-2 bg-white rounded-xl shadow-light-tight-1 dark:shadow-dark-tight-1 py-2 px-3"
    >
      <div className="flex items-center gap-[10px] pb-1 border-b-0.5 border-neutral-100 dark:border-neutral-700">
        <Avatar radius="sm" size="sm" src={icon} />
        <h3 className="text-base font-semibold text-secondary-1000 wrap-break-word ">nahira</h3>
      </div>
