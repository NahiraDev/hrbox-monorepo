...
import {AppAutoComplete, AppCheckBox, AppTextArea} from "@hrbox/uikit/components";
    ...
    return (
        <Form onSubmit={handleSubmit}>
            <div className="flex flex-col gap-[24px]">
                ...
                <div
                    className=" flex items-center flex-row justify-between w-full bg-[rgba(220,240,249,0.40)] dark:bg-[rgba(4,66,92,0.60)] rounded-[8px]">
                ...
                <div className="p-[16px] w-full">
                    <div className="flex flex-row gap-10 w-full justify-between py-4">
                        <div className="flex">
                            <p>Actioners:</p>
                        </div>
                        <div className="flex flex-row">
                ...
                {values.notifications === 2 && (
                    <div className="flex flex-col gap-[6px] ">
                        <div
                            ...
                            <div className="flex mx-auto my-3 w-full">
                                <FormField
