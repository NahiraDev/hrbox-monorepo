...
import { jobDescriptions } from "@hrbox/modules/jobDescription/app/mock";
...
const Jobdescription = () => {
  ...
  const handlePage = (page: number) => {
    ...
    <div className="flex flex-row flex-wrap gap-3 ">
        ...
        <JobDescriptionCard key={item.id} title={item.title} correctionDate={item.correctionDate} positionCode={item.positionCode}  />
        ))}
    </div>
