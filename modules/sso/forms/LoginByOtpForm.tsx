        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-600">
              {t("code_sent_to")}: {selectedCountry?.dialCode}
              {values.UsernameOrMobile}
            </span>
            <button
              type="button"
          ...
          {timeLeft === 0 && (
            <div className="text-sm text-red-500">{t("code_expired")}</div>
          )}
        </div>
      ...
      <div className="flex flex-col gap-4 w-full">
        <div className="flex flex-col gap-1">
          <FormField
            ...
            type="tel"
            placeholder={
              selectedCountry?.placeholder || t("enter_phone_number")
            }
