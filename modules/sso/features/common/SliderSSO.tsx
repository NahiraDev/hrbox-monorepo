...
const SliderSSO = () => {
  ...
  const [isOrganizePanel , setIsOrganizePanel] = useState(true);
      ...
      <div className="relative">
        ...
        <div className="flex justify-center gap-2 mt-6">
          {[0, 1, 2].map((index) => (
            ...
            >
              {activeIndex === index && (
                <span className="absolute inset-0 rounded-full bg-primary-400 animate-pulse opacity-50" />
              )}
            </button>
          ))}
        </div>
