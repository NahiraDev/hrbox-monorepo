...
const FaceAllocationEdit = () => {
  ...
  return (
    <>
      <Form id="face-allocation-edit" onSubmit={handleSubmit}>
        <div className="flex flex-col w-full gap-7">
          ...
          <div className="flex flex-row justify-between gap-10">
            <div className="w-full">
              <FormField name="ChooseFace" label="Choose Face Recognition Assignment" component={AppAutoComplete} />
            </div>
            <div className="w-full">
              <FormField name="FromDate" label="From Date" component={AppAutoComplete} />
            </div>
          </div>
          <div className="flex flex-row justify-between gap-10">
            <div className="w-full">
...
export default FaceAllocationEdit;
