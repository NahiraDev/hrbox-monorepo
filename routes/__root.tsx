                    ...
                    fallback={
                        <div className="flex h-full items-center justify-center">
                            <div className="text-center">
                                <div
                                    className="inline-block animate-spin h-12 w-12 border-4 border-primary-500 border-t-transparent rounded-full mb-4"/>
    ...
    errorComponent: ({error}) => (
        <div className="flex h-screen items-center justify-center bg-panel-background">
            <div className="max-w-md text-center p-8 bg-panel-surface rounded-2xl shadow-theme-lg">
                ...
                {import.meta.env.DEV && (
                    <pre
                        className="mt-4 p-4 bg-neutral-100 dark:bg-neutral-800 rounded-lg text-left text-xs overflow-auto max-h-40">
            {error.stack}
          </pre>
                )}
