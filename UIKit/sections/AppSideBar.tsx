    ...
    return (
        <>
            <motion.div
                ...
                className="relative flex flex-col h-full rounded-lg py-4 px-4 bg-white shadow-theme-md"
            >
                ...
                <div className="flex flex-col items-center justify-between w-full h-full">
                                ...
                                return (
                                    ...
                                    >
                                        <button
                                            ...
                                            className={`
                      relative flex items-center gap-3 w-full px-3 py-2.5 transition-all
                      ${isActive
                                                ? 'dark:bg-primary-900/20 text-[#FD1B51] border-b-1 border-[#FD1B51]'
                    ...
                    `}
                                        ...
                                        >
                                            <span className={`flex-shrink-0 ${isActive ? 'text-[#FD1B51]' : ''}`}>
                      {item.icon}
                    </span>
                                            <AnimatePresence>
                                                {isExpanded && (
                                                    <motion.span
                                                        ...
                                                        className={`text-sm font-medium whitespace-nowrap overflow-hidden ${
                                                            isActive ? 'text-[#FD1B51]' : 'dark:text-neutral-400'
                                                        }`}
                                                    >
                                                        {item.label}
                                                    </motion.span>
                                            ...
                                            {isActive && (
                                                <motion.div
                                                    ...
                                                    className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-8 bg-[3FD1B51] rounded-r-full"
